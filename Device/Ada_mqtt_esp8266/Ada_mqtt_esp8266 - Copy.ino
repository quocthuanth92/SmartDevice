...
void loop() {
  ...
  while ((subscription = mqtt.readSubscription(5000))) {
    if (subscription == &onoffbutton) {
      ...
      if (strcmp((char* )onoffbutton.lastread,"O2") == 0) {
        // Gọi mở Rơ le ở đây
        digitalWrite(12, 1);   // dieu khien ro le mo 
        Serial.println(" Role on");
        // it is acive low on the ESP-01)
      } 
      if(strcmp((char* )onoffbutton.lastread,"F2") == 0)
      {
        // Gọi đóng Rơ le ở đây
        digitalWrite(12, 0);  // Dieu khien role dong
         Serial.println(" Role on");
        // Ham doc trang thai role i = digitalRead(2);
      }
      
      if (strcmp((char* )onoffbutton.lastread,"4") == 0) {
        // Gọi mở Rơ le ở đây
        digitalWrite(2, 1);   // dieu khien ro le mo 
        Serial.println(" Role on");
        // it is acive low on the ESP-01)
      } 
      ...
      {
        // Gọi đóng Rơ le ở đây
        digitalWrite(2, 0);  // Dieu khien role dong
         Serial.println(" Role on");
        // Ham doc trang thai role i = digitalRead(2);
      }
      ...
      if (strcmp((char* )onoffbutton.lastread,"8") == 0) {
        // Gọi mở Rơ le ở đây
        digitalWrite(14, 1);  
      } 
      if(strcmp((char* )onoffbutton.lastread,"9") == 0)
      {
        // Gọi đóng Rơ le ở đây
        digitalWrite(14, 0);  
      }
